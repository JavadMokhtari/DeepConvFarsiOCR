...
def Train(params):
    ...
    ocr_model_v2 = keras.models.Sequential([
    ...
    # Compile Model
    ocr_model_v2.compile(optimizer='adam',
    ...
    model_history = ocr_model_v2.fit(train_ds,
        epochs=epochs,
    ...
    # Save model
    ocr_model_v2.save(os.path.join(model_storage_dir, 'ocr_model_v2.h5'))
